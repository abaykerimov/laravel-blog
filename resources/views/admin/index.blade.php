...
<head>
    ...
    <script src="/js/admin/require.min.js"></script>
    <script>
        requirejs.config({
            baseUrl: ''
        });
            ...
            <div class="container">
                <div class="d-flex">
                    ...
                    <div class="d-flex order-lg-2 ml-auto">
                      ...
                      <span class="text-default">Aisha Seitmetova</span>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg order-lg-first">
                        <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                            <li class="nav-item">
                                <a href="/pages/index.html" class="nav-link active"><i class="fe fe-home"></i> Home</a>
                            </li>
                            <li class="nav-item">
                                <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i class="fe fe-box"></i> Interface</a>
                                <div class="dropdown-menu dropdown-menu-arrow">
                                    <a href="/pages/cards.html" class="dropdown-item ">Cards design</a>
                                    <a href="/pages/charts.html" class="dropdown-item ">Charts</a>
                                    <a href="/pages/pricing-cards.html" class="dropdown-item ">Pricing cards</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i class="fe fe-calendar"></i> Components</a>
                                <div class="dropdown-menu dropdown-menu-arrow">
                                    <a href="/pages/maps.html" class="dropdown-item ">Maps</a>
                                    <a href="/pages/icons.html" class="dropdown-item ">Icons</a>
                                    <a href="/pages/store.html" class="dropdown-item ">Store</a>
                                    <a href="/pages/blog.html" class="dropdown-item ">Blog</a>
                                    <a href="/pages/carousel.html" class="dropdown-item ">Carousel</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-arrow">
                                    ...
                                    <a href="/pages/forgot-password.html" class="dropdown-item ">Forgot password</a>
                                    <a href="/pages/400.html" class="dropdown-item ">400 error</a>
                                    <a href="/pages/401.html" class="dropdown-item ">401 error</a>
                                    <a href="/pages/403.html" class="dropdown-item ">403 error</a>
                                    <a href="/pages/404.html" class="dropdown-item ">404 error</a>
                                    <a href="/pages/500.html" class="dropdown-item ">500 error</a>
                                    <a href="/pages/503.html" class="dropdown-item ">503 error</a>
                                    <a href="/pages/email.html" class="dropdown-item ">Email</a>
                                    <a href="/pages/empty.html" class="dropdown-item ">Empty page</a>
                                    <a href="/pages/rtl.html" class="dropdown-item ">RTL mode</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a href="/pages/form-elements.html" class="nav-link"><i class="fe fe-check-square"></i> Forms</a>
                            </li>
                            <li class="nav-item">
                                <a href="/pages/gallery.html" class="nav-link"><i class="fe fe-image"></i> Gallery</a>
                            </li>
                            <li class="nav-item">
                                <a href="/pages/docs/index.html" class="nav-link"><i class="fe fe-file-text"></i> Documentation</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="my-3 my-md-5">
            <div class="container">
                ...
                <div class="row row-cards">
                    ...
                    <div class="col-md-6">
                        <div class="alert alert-primary">Are you in trouble? <a href="../../../public/pages/docs/index.html" class="alert-link">Read our documentation</a> with code samples.</div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-header">
                        ...
                        <div class="card card-aside">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center pt-5 mt-auto">
                                    ...
                                    <div>
                                        <a href="../../../public/pages/profile.html" class="text-default">Rose Bradley</a>
                        ...
                        <div class="card card-aside">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center pt-5 mt-auto">
                                    ...
                                    <div>
                                        <a href="../../../public/pages/profile.html" class="text-default">Peter Richards</a>
                                        <small class="d-block text-muted">3 days ago</small>
                                    </div>
                                    <div class="ml-auto text-muted">
                                        <a href="javascript:void(0)" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i></a>
                            ...
                            <div class="table-responsive">
                                <table class="table card-table table-vcenter text-nowrap">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="../../../public/pages/invoice.html" class="text-inherit">Design Works</a></td>
                                        <td>
                                            Carlson Limited
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="../../../public/pages/invoice.html" class="text-inherit">UX Wireframes</a></td>
                                        <td>
                                            Adobe
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="../../../public/pages/invoice.html" class="text-inherit">New Dashboard</a></td>
                                        <td>
                                            Bluewolf
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="../../../public/pages/invoice.html" class="text-inherit">Landing Page</a></td>
                                        <td>
                                            Salesforce
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="../../../public/pages/invoice.html" class="text-inherit">Marketing Templates</a></td>
                                        <td>
                                            Printic
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="../../../public/pages/invoice.html" class="text-inherit">Sales Presentation</a></td>
                                        <td>
                                            Tabdaq
                                        </td>
                                        <td>
