        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                    <li class="nav-item">
                        <a href="{{ url()->route('admin.posts.index') }}" class="nav-link active"><i class="fe fe-home"></i> Рассказы</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url()->route('admin.posts.index') }}" class="nav-link"><i class="fe fe-box"></i> Комментарии</a>
                    </li>
                    {{--<li class="nav-item">--}}
